...
class __Mustache_0c06b7587add6daf81801b5ca5fabb55 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="alert alert-icon alert-info alert-block alert-dismissible fade show ';
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    <i class="icon wb-info" aria-hidden="true"></i>
';
        $buffer .= $indent . '    ';
