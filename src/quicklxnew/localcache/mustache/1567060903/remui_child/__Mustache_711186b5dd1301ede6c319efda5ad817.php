...
class __Mustache_711186b5dd1301ede6c319efda5ad817 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="alert alert-icon alert-warning alert-block alert-dismissible fade show ';
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    <i class="icon wb-alert" aria-hidden="true"></i>
';
        $buffer .= $indent . '    ';
