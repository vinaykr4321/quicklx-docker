...
class iomad_company_select_form extends moodleform {
    ...
    public function definition() {
        $mform =& $this->_form;
        $autooptions = array('onchange' => 'this.form.submit()','style'=>'width:45% !important;margin-top: 3%;');
        $mform->addElement('select', 'company', get_string('selectacompany', 'block_iomad_company_selector'), $this->companies, $autooptions);
 ...
 public function has_config() {
    ...
    public function get_content() {
        ...
        if (iomad::has_capability('block/iomad_reports:view', $context)) {
            $tabs[7] = get_string('reports_tab', 'block_iomad_company_admin');
        }
        ...
        foreach ($menus as $key => $menu) {
            ...
            $html .= '<div class="iomadicon ' . $menu['style'] . '"><div class="fa fa-topic '. $menu['icon'] .'"> </div>';
