...
$string['companyrolemanager'] = 'Company Report Manager';
...
$string['unlimitedlicensetotal'] = ' Unlimited licenses available for allocation';
...
$string['userlicenseshortened'] = 'License shortened for user';
$string['userlicenserenewed'] = 'License renewed for user';
$string['userlicenseextended'] = 'License extended for user';
...
$string['selectlicense'] = 'Select license';



/* Custom Code Added  */

$string['licenseformat'] = "License format";
$string['licenseformat_help'] = "Shared license will be used for copying the existing license";
$string['ishared'] = "Is shared";
$string['permittedcompanies'] = "Select permitted companies";
$string['parentlicense'] = "Parent license (If creating new shared license, selecting multiple parent licenses creates one new shared license for each parent.)";
$string['unlimitedseats_help'] = "Selecting Unlimited license sets number of allocated seats to 9,999,999";
$string['unlimitedseats'] = "Unlimited license";
$string['removetags'] = "Remove all tags";
$string['removetags_help'] = "Selecting will remove all the tags";
$string['removecourse'] = "Remove all courses";
$string['removecourse_help'] = "Selecting will remove all the courses";
$string['selecttags'] = "Select tags you want to include in this license. Courses with selected tags applied will be included.";
$string['selectedcourses'] = "Courses from parent license:";
$string['selectedtags'] = "Tags from parent license:";
$string['user_access_expiration'] = "User access expiration";
$string['reports_tab'] = "Reports";
$string['splash'] = "Login page image";
//gnuwings
$string['licenseselfreg'] = 'User self registered to ';
$string['aws_region'] = 'AWS Region';
$string['configawsregion'] = 'Configure Region';
$string['aws_secret'] = 'AWS Secret';
$string['configawssecret'] = 'Configure Secret';
$string['aws_key'] = 'AWS Key';
$string['configawskey'] = 'Configure Key';
$string['activatehostname'] = 'Activate hostname';
$string['companydomainexist'] = 'This subdomain already exists. You can not re-use an existing subdomain. Please contact support to override this requirement.';
$string['admineports'] = 'Admin reports';

//Custom Code - Syllametrics - April/May 2019
$string['hassso'] = 'Company SSO';
$string['hassso_help'] = 'If this company has an sso, the site can be accessed via SSO using the hostname as subdomain. Users will not be allowed to change password.';
$string['expiredcourse'] = 'Display expired course information';

$string['enableregkey'] = 'Enable Reg Keys';
$string['registraionkey'] = 'Manage Registration Keys';