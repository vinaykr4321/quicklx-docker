...
class block_iomad_company_admin_renderer extends plugin_renderer_base {
    ...
    public function department_tree($tree, $selected) {
        $html = '';
	$html = '<label style="margin-bottom: 0px !important;">Department<a class="btn btn-link p-a-0" role="button" data-container="body" data-toggle="popover" data-placement="left" data-content="<div class=&quot;no-overflow&quot;><p>If your group contains departments/subgroups, you will see an arrow next to your group name. Click the arrow to show your departments/subgroups. Click a department/subgroup to view or set results for that group.</p></div> " data-html="true" tabindex="0" data-trigger="focus" data-original-title="" title=""><i class="icon fa fa-question-circle text-info fa-fw " aria-hidden="true" title="Help with department/subgroup selection" aria-label="Help with department/subgroup selection" style="margin-top:-3px;"></i></a></label>';
