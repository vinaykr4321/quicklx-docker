...
//  Display the course home page.
    ...
    $course_exit = $DB->get_records_sql("SELECT e.courseid FROM `mdl_user_enrolments` as ue join `mdl_enrol` as e ON ue.enrolid = e.id where e.courseid = $course->id and ue.userid = $USER->id and ue.timeend < unix_timestamp()");
    if(empty($course_exit)){
       require($CFG->dirroot .'/course/format/'. $course->format .'/format.php');
    }else{
       echo $OUTPUT->heading(get_string('cuursecannotaccess','enrol'));
    }
    // Content wrapper end.
