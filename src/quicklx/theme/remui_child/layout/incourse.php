...
$flatnavigation = child_flatnav_icon_support($PAGE->flatnav);
...
if (!preg_match('#/course/view.php#', $PAGE->url)) {
    if ($COURSE->format != 'singleactivity') {
        ...
        if ($activityid != -1) {
            $templatecontext['prevnextnav'] = child_activities_navigation_previous_next($PAGE->pagelayout, $activityid, $COURSE);
        }
    }
}
// Activities Navigation Previous Next
