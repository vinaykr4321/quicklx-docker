 ...
 * @return string
 */
function theme_remui_child_process_css($css, $theme)
{
    global $PAGE, $OUTPUT;
...
function remui_child_clear_cache()
{
    theme_reset_all_caches();
}

function child_flatnav_icon_support($flatnav)
{
    global $CFG, $USER;
...
function child_activities_navigation_previous_next($pagelayout = null, $id = null, $course = null)
{
    global $USER, $CFG;
