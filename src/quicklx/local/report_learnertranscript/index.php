...
// Url stuff.
$url = new moodle_url('/local/report_learnertranscript/index.php');
...
$url = new moodle_url('/local/report_learnertranscript/index.php', $params);
...
$reporthead = 'Learner Transcript Report';
	...
	$mform = new iomad_learnertranscript_filter_form($params);
...
if($exportuserdataobj){
	...
	$array_excel[] =array();
	 ...
	 $array_excel[] = array(get_string('login', 'local_base'),
...
if($userdataobj){
	...
	foreach($userdataobj as $user){
		...
		$params['selectuser']=$user->id;
		$userurl = new moodle_url('/local/report_learnertranscript/report_card.php', $params);
		$useraction = html_writer::link($userurl, $user->username,array('title'=>'Learner\'s Transcript Report'));  
	...
	echo $output->paging_bar($totalcount, $page, $perpage, new moodle_url('/local/report_learnertranscript/index.php', $params));
	echo "<br />"; 
			...
			<input type="hidden" name="userarrayid" value="'. $userarrayid. '">
                   ...
                   echo    ' </select>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Enter email subject" value="Learner Transcript Report"/>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">      <!-- Modal Header -->
			...
			<input type="hidden" name="screen" value="1">
			  <div class="form-group">
                        ...
                        placeholder="Enter Description" value="Learner Transcript"/>
                    </div>
                      <div class="form-group">
                        <label >Report Format:</label><br>
                   ...
                   echo    ' </select>
                     ...
                     <div class="form-group">
                        ...
                        placeholder="Enter email subject" value="Learner Transcript"/>
                    </div>
                    <div class="form-group">
