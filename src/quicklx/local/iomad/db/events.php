...
$observers = array(
    ...
    array(
        'eventname'   => '\block_iomad_company_admin\event\user_license_shortened',
        'callback'    => 'local_iomad_observer::user_license_shortened',
        'includefile' => '/local/iomad/classes/observer.php'
    ),

     array(
        'eventname'   => '\block_iomad_company_admin\event\user_license_extended',
        'callback'    => 'local_iomad_observer::user_license_extended',
        'includefile' => '/local/iomad/classes/observer.php'
    ),

     array(
        'eventname'   => '\block_iomad_company_admin\event\user_license_renewed',
        'callback'    => 'local_iomad_observer::user_license_renewed',
        'includefile' => '/local/iomad/classes/observer.php'
    ),
);
