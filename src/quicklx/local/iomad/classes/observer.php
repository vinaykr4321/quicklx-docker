...
class local_iomad_observer {
    ...
    public static function user_course_expired($event) {
     ...
     /**
     * Triggered via block_iomad_company_admin::user_license_shortened event.
     *
     * @param \block_iomad_company_admin\event\user_license_shortened $event
     * @return bool true on success.
     */
    public static function user_license_shortened($event) {
        company::user_license_shortened($event);
        return true;
    }
     /**
     * Triggered via block_iomad_company_admin::user_license_extended event.
     *
     * @param \block_iomad_company_admin\event\user_license_extended $event
     * @return bool true on success.
     */
    public static function user_license_extended($event) {
        company::user_license_extended($event);
        return true;
    }
    /**
     * Triggered via block_iomad_company_admin::user_license_renewed event.
     *
     * @param \block_iomad_company_admin\event\user_license_renewed $event
     * @return bool true on success.
     */
    public static function user_license_renewed($event) {
        company::user_license_renewed($event);
        return true;
    }
}
