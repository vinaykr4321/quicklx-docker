...
iomad::require_capability('local/report_completionstatus:view', $context);
...
// Url stuff.
$url = new moodle_url('/local/report_completionstatus/index.php');
$dashboardurl = new moodle_url('/local/iomad_dashboard/index.php');

// Page stuff:.
$strcompletion = get_string('pluginname', 'local_report_completionstatus');
$PAGE->set_url($url);
...
$url = new moodle_url('/local/report_completionstatus/index.php', $params);
...
// Only print the header if we are not downloading.
	...
	$mform = new iomad_completionstatus_filter_form($params);
...
$sql = "select distinct(c.id),name from {company} c 
	...
	if($coursedataobj){
		...
		$coursecomptable->align = array('left', 'center', 'center', 'center', 'center', 'center', 'center', 'center', 'center', 'center');
...
$sql = "select distinct(c.id),name from {company} c 
		...
		echo '<div id="exportbuttons" style="text-align: center;">	';
		  ...
		  $PAGE->set_url('/local/base/download_excel.php',array('name'=>'completionstatus'));
		echo "<br>".$OUTPUT->single_button(new moodle_url($PAGE->url, array('exceldata' => json_encode($array_excel))),  get_string("downloadexcel", 'local_base'));
		 ...
		 $PAGE->set_url('/local/base/download_csv.php',array('name'=>'completionstatus'));
		...
		$PAGE->set_url('/local/base/download_pdf.php',array('name'=>'completionstatus'));
		...
		echo $output->paging_bar($totalcount, $page, $perpage, new moodle_url('/local/report_completionstatus/index.php', $params));
		echo "<br />"; 
			 ...
			 <input type="hidden" name="userarrayid" value="'. $userarrayid. '">
                   ...
                   echo    ' </select>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Enter email subject" value=" Completion status report"/>
                    </div>
                    <div class="form-group">
 ...
 <div class="modal fade" id="schedulereportForm" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">      <!-- Modal Header -->
			...
			<input type="hidden" name="reportname" value="completionstatus">
			<input type="hidden" name="screen" value="1">
			  <div class="form-group">
                        <label for="description">Schedule Description:</label>
                        <input type="text" class="form-control" id="description" 
                        placeholder="Enter Description" value=" Completion Status"/>
                    </div>
                      <div class="form-group">
                        <label >Report Format:</label><br>
                   ...
                   echo    ' </select>
                     ...
                     <div class="form-group">
                        ...
                        placeholder="Enter email subject" value="Completion Status"/>
                    </div>
                    <div class="form-group">
