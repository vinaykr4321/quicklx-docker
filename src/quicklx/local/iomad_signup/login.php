...
$url = '';
if ($wantedcompanyid !=0) 
{           
    $imagedata = $DB->get_record_sql("SELECT f.* FROM {files} f JOIN {company} c on c.splashimage = f.itemid WHERE c.id= $wantedcompanyid AND f.mimetype !='' AND f.filearea = 'splashimage' ");
