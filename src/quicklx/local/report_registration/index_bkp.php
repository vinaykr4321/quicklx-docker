...
//	$isdata = 0;
	...
	foreach($userdataobj as $logevent){
		...
		//echo $licenseid;
		// Custom Code - Syllametrics - Updated (11/03/2019)
		$toprint =1;
				...
				*/
		        ...
		        if ($comapnyid) {
				 ...
				 $coursecomptable->data[] = array(
								...
								/*$logevent->id.'--'.date('m/d/Y',$logevent->timecreated),
								$licensename,
								$coursefullname,
								$action,
								$user->username,
