...
iomad::require_capability('local/report_user_registration:view', $context);
...
// Url stuff.
$url = new moodle_url('/local/report_user_registration/index.php');
$dashboardurl = new moodle_url('/local/iomad_dashboard/index.php');

// Page stuff:.
$strcompletion = get_string('pluginname', 'local_report_user_registration');
$PAGE->set_url($url);
...
$url = new moodle_url('/local/report_user_registration/index.php', $params);
...
// Only print the header if we are not downloading.
	...
	$returnobj = report_user_registration::get_all_registered_users($departmentid, 0, $params);
	...
	$mform = new iomad_user_registration_filter_form($params);
...
$sql = "select distinct(c.id),name from {company} c 
		...
		$array_excel[] = array($user->username,
										...
										empty($user->lastaccess) ? "" : date('m/d/Y',$user->lastaccess),
										$countloggedin);
		if($i%2==0)
...
$sql = "select distinct(c.id),name from {company} c 
	...
	echo '<div id="exportbuttons" style="text-align: center;">	';
	  ...
	  $PAGE->set_url('/local/base/download_excel.php',array('name'=>'userregistration'));
    echo "<br>".$OUTPUT->single_button(new moodle_url($PAGE->url, array('exceldata' => json_encode($array_excel))),  get_string("downloadexcel", 'local_base'));
     ...
     $PAGE->set_url('/local/base/download_csv.php',array('name'=>'userregistration'));
    ...
    $PAGE->set_url('/local/base/download_pdf.php',array('name'=>'userregistration'));
	...
	echo $output->paging_bar($totalcount, $page, $perpage, new moodle_url('/local/report_user_registration/index.php', $params));
	echo "<br />"; 
			 ...
			 <input type="hidden" name="userarrayid" value="'. $userarrayid. '">
                   ...
                   echo    ' </select>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Enter email subject" value="User registration report"/>
                    </div>
                    <div class="form-group">
 ...
 <div class="modal fade" id="schedulereportForm" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">      <!-- Modal Header -->
			...
			<input type="hidden" name="reportname" value="user_registration">
			<input type="hidden" name="screen" value="1">
			  <div class="form-group">
                        <label for="description">Schedule Description:</label>
                        <input type="text" class="form-control" id="description" 
                        placeholder="Enter Description" value=" User Registration"/>
                    </div>
                      <div class="form-group">
                        <label >Report Format:</label><br>
                   ...
                   echo    ' </select>
                     ...
                     <div class="form-group">
                        ...
                        placeholder="Enter email subject" value="User Registration"/>
                    </div>
                    <div class="form-group">
