    ...
    public static function getmenu() {
        ...
        $returnarray = array(
            ...
            'downloadusers' => array(
                 ...
                 * Syllametrics
                 * Update: Oct 19 2018
                 * Base permission on edit license capability instead of upload capability
                */
             ...
             * Syllametrics
             * Update: Oct 23 2018
             * Add new option user access expiration
            */
            'useraccessexpiration' => array(
                'category' => 'UserAdmin',
                'tab' => 2,
                'name' => get_string('user_access_expiration', 'block_iomad_company_admin'),
                'url' => '/local/useraccessexpiration/index.php',
                'cap' => 'block/iomad_company_admin:company_add',
                'icondefault' => 'users',
                'style' => 'user',
                'icon' => 'fa-group',
        ...
        $returnarray['EmailTemplates'] = array(
         ...
         $returnarray['createkeys'] = array(
            'category' => 'CompanyAdmin',
            'tab' => 1,
            'name' => get_string('registraionkey', 'block_iomad_company_admin'),
            'url' => '/local/report_createkeys/index.php',
            'cap' => 'local/report_createkeys:view',
            'icondefault' => 'emailtemplates',
            'style' => 'company',
            'icon' => 'fa-key',
            'iconsmall' => 'fa-gear'
