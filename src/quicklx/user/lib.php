...
function user_get_user_navigation_info($user, $page, $options = array()) {
    ...
    if ($returnobject->metadata['asotheruser'] = \core\session\manager::is_loggedinas()) {
        ...
        * Set code for custom company logout page
       */
        ...
        $logout->url = new moodle_url('/login/logout.php', array('sesskey' => sesskey(),'id' => $USER->company->id, 'code' => $USER->company->shortname));
        $logout->pix = "a/logout";
