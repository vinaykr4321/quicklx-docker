...
$string['companycertify'] = 'This Certificate of Completion recognizes that';
$string['companydetails'] = 'has successfully completed the online training program titled';
